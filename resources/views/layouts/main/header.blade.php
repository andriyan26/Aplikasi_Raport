      ...
      <ul class="navbar-nav ml-auto">
        ...
        <a class="user-block" data-toggle="dropdown" href="#">
          ...
          @elseif (Auth::user()->role == 5)
            <img class="img-circle" src="/assets/dist/img/avatar/{{ Auth::user()->wakilKurikulum->avatar }}" alt="User Image">
        ...
        <!-- End User Block  -->
          ...
          <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
            ...
            <div class="dropdown-divider"></div>
            <a href="{{ route('logout') }}" class="dropdown-item dropdown-footer bg-danger" onclick="return confirm('Apakah anda yakin ingin keluar ?')">
