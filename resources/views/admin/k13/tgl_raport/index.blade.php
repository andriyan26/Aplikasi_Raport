                          ...
                          <form action="{{ route('k13tglraport.update', $tgl_raport->id) }}" method="POST">
                            ...
                            <div class="modal-body">
                              ...
                              <div class="form-group row">
                                <label for="tanggal_pembagian" class="col-sm-3 col-form-label">Tanggal Pembagian</label>
                              <div class="col-sm-9">
                                  <input type="date" class="form-control" id="tanggal_pembagian" name="tanggal_pembagian"
                                        value="{{ \Illuminate\Support\Carbon::parse($tgl_raport->tanggal_pembagian)->format('Y-m-d') }}">
                              </div>
                              </div>
                            </div>
                            <div class="modal-footer justify-content-end">
