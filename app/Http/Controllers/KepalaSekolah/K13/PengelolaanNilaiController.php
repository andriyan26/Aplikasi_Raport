...
class PengelolaanNilaiController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('kepalasekolah.k13.pengelolaannilai.pilihkelas', compact('title', 'data_kelas'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return view('kepalasekolah.k13.pengelolaannilai.index', compact('title', 'kelas', 'data_kelas', 'sekolah', 'data_anggota_kelas'));
    }
