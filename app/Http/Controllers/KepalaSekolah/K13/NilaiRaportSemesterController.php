...
class NilaiRaportSemesterController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('kepalasekolah.k13.nilairaport.pilihkelas', compact('title', 'data_mapel', 'data_kelas'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            if (is_null($pembelajaran)) {
                ...
                return view('kepalasekolah.k13.nilairaport.index', compact('title', 'mapel', 'kelas', 'data_mapel', 'data_kelas', 'data_anggota_kelas'));
            }
        }
    }
