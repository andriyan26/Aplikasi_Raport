...
class StatusPenilaianController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('kepalasekolah.ktsp.statuspenilaian.pilihkelas', compact('title', 'data_kelas'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return view('kepalasekolah.ktsp.statuspenilaian.index', compact('title', 'kelas', 'data_kelas', 'data_pembelajaran_kelas'));
    }
}
