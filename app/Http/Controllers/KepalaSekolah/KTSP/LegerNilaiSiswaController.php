...
class LegerNilaiSiswaController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('kepalasekolah.ktsp.legernilai.pilihkelas', compact('title', 'data_kelas'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return view('kepalasekolah.ktsp.legernilai.index', compact('title', 'kelas', 'data_kelas', 'data_mapel_wajib', 'data_mapel_pilihan', 'data_mapel_muatan_lokal', 'data_ekstrakulikuler', 'count_ekstrakulikuler', 'data_anggota_kelas'));
    }
