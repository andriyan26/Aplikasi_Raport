...
class CetakRaportSemesterController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('kepalasekolah.ktsp.raportsemester.setpaper', compact('title', 'data_kelas'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return view('kepalasekolah.ktsp.raportsemester.index', compact('title', 'kelas', 'data_kelas', 'data_anggota_kelas', 'paper_size', 'orientation'));
    }
