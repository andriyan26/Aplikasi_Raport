...
class RekapKehadiranSiswaController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('kepalasekolah.rekapkehadiran.pilihkelas', compact('title', 'data_kelas'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return view('kepalasekolah.rekapkehadiran.index', compact('title', 'kelas', 'data_kelas', 'data_anggota_kelas'));
    }
